    ...
    <>
      ...
      <div className=" text-center p-5 md:p-40">
        <h1>
          ...
          moments of joy and wear smiles on your face. Be extremely happy and
          keep smiling. Remember, I will always be there to support you, no
          matter what you find or face. You can count on me.
        </h1>
      </div>
      <div className="h-96"></div>
    </>
